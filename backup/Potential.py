...
def get_occupation(structure_prim: Structure):
...
def get_ref_system(structure_prim: Structure):
...
def get_mesh_info(structure_prim: Structure):
    structure = SgA(structure_prim).get_conventional_standard_structure()
...
def get_types(structure_prim: Structure):
...
def generate_pot(poscar: Path):
    structure = SgA(Structure.from_file(poscar)).get_conventional_standard_structure()
